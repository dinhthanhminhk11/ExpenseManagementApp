package com.example.expensemanagementapp.ui.customview.pinview;
...
public class OtpView extends AppCompatEditText implements View.OnKeyListener {
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        if (getText().toString().length() == 6 && keyCode == KeyEvent.KEYCODE_DEL) {
            setLineColor(ContextCompat.getColor(getContext(), R.color.color_gray_C7));
        }
        return false;
    }
    ...
    private void drawInput(Canvas canvas, int i) {
        ...
        if (maskingChar != null && (isNumberInputType(getInputType()) || isPasswordInputType(getInputType()))) {
